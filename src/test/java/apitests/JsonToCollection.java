...
public class JsonToCollection {
    ...
    public void allSpartanWithList(){
        ...
        System.out.println(allSpartanList.get(2).get("name"));
        ...
        Map<String,Object> spartan5 = allSpartanList.get(4);
        System.out.println(spartan5.get("name"));
    ...
    public void regionJsonMap() {
        ...
        List<Map<String, Object>> linkList = (List<Map<String, Object>>) itemsList.get(1).get("links");
        System.out.println(linkList);
        System.out.println(linkList.get(0).get("href"));
